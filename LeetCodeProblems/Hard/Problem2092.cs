...
{
    /// <summary>
    /// <see href="https://leetcode.com/problems/find-all-people-with-secret">Find All People With Secret</see>
    /// <br>Depth-First Search, Breadth-First Search, Union Find, Graph, Sorting</br>
    /// </summary>
    internal class Problem2092
    {
        public IList<int> FindAllPeople(int n, int[][] meetings, int firstPerson)
        {
            // no my solution. it's to hard for me :(
